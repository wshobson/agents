...
class TestCopilotAdapter:
    ...
    def test_model_alias_resolution(self, tmp_path: Path, output_root: Path):
        ...
        agents = []
        for name, model in [("sonnet-agent", "sonnet"), ("haiku-agent", "haiku"), ("inherit-agent", "inherit")]:
        ...
        expected = {"sonnet-agent": "gpt-5-mini", "haiku-agent": "gpt-5-nano", "inherit-agent": "gpt-5", "default-model": "gpt-5"}
