...
Production-ready agentic-workflow building blocks: **95 plugins** (92 local + 2 external), **203 agents**, **184 skills**, **106 commands**. Native source-of-truth for Claude Code; also consumed by OpenAI Codex CLI, Cursor, OpenCode, the Google Antigravity CLI (`agy`), and Pi from a single Markdown source.
