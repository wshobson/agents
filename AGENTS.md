...
Production-ready agentic-workflow building blocks: **95 plugins** (91 local + 4 external), **204 agents**, **180 skills**, **109 commands**. Native source-of-truth for Claude Code; also consumed by OpenAI Codex CLI, Cursor, OpenCode, and Gemini CLI from a single Markdown source.
...
- **[docs/agents.md](docs/agents.md)** — agent reference (204 agents, model tiers)
...
204 subagents under `plugins/*/agents/<name>.md`. Per-harness transpilation:
