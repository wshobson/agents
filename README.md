...
> **157 skills**, **102 commands** — built for Claude Code and consumed natively by
...
| **Skills** | 157 | Modular knowledge packages with progressive disclosure (load when activated) |
...
- **[docs/agent-skills.md](docs/agent-skills.md)** — 157 skills with progressive disclosure
