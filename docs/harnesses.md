...
| Capability | Claude Code | Codex | Cursor | OpenCode | Gemini | Antigravity |
|:---|---|---|---|---|---|---|
...
| Bare model aliases | ✅ (`opus`/`sonnet`/`haiku`) | mapped to GPT-5 family | use `inherit` | full provider/model-id | mapped to `gemini-2.5-*` | mapped to `gemini-2.5-*` |
...
| Source pattern | Codex | Cursor | OpenCode | Gemini | Antigravity |
|---|---|---|---|---|---|---|
