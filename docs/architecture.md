...
- **95 marketplace plugins** (91 local + 4 external via git-subdir) optimized for specific use cases
...
- **100% component availability** - all 204 local agents accessible across plugins
