...
```
Task:
  subagent_type: "incident-response-incident-error-detective"
...
```
Task:
  subagent_type: "incident-response-incident-code-reviewer"
...
```
Task:
  subagent_type: "incident-response-incident-test-automator"
