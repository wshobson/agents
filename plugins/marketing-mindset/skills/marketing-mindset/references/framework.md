# Framework — principles, sources of truth, hypotheses

Deep material behind the `marketing-mindset` skill: the principles, the sources of truth, how to form hypotheses, and the honest limits of what numbers can tell you.
...
There is a gate for this. Ask the one question that matters before anything else: do you have your first client yet? If the answer is not "me" — the user has not used their own product — the skill waits, and the next move is product, not marketing.
