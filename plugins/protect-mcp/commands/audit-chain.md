...
4. Reports the line number of each receipt that fails
...
Exit 0 means every receipt verified. Exit 1 means at least one receipt failed,
and exit 2 means the file could not be read.
